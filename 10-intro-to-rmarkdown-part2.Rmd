...
You can name your chunk anything you want although it is reccomended to use something descriptive ie 'load_data', 'read_libraries' etc. 
...
There are a number of other parameters with more details [here](https://yihui.org/knitr/options/#code-evaluation)
...
>
> Markdown documents can be compiled to PDF, however it will likely you will require additional > software called LaTex. This software can be tricky to install and it is reccommended to use  

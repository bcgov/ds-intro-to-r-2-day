...
```
The predicted effect of per-capita GDP on life expectancy is `r knitr::inline_expr("life_exp_estimate")` 
(SE: `r knitr::inline_expr("life_exp_se")`), meaning that for every dollar increase in per-capita GDP
we live longer by approximately `r knitr::inline_expr("life_exp_esimate")` years.
```

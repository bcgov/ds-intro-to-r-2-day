...
```
The predicted effect of life expectancy on per-capita GDP is `r knitr::inline_expr("life_exp_estimate")` 
(SE: `r knitr::inline_expr("life_exp_se")`), meaning that for every year we live longer, our per-capita GDP
increases by approximately `r knitr::inline_expr("life_exp_esimate")`.
```

...
In our initial breakout sessions, we all downloaded and opened a new RStudio 
Project called `intro-to-r-course-notes`, by running the following code:
...
This created a new R project folder in your user directory (`C:/Users/[your_user_name]/intro-to-r-course-notes/` on Windows, 
and `/Users/[your_user_name]/intro-to-r-course-notes/` on a Mac). 
...
3. Put raw data and metadata in the `data` directory, and files generated during cleanup and analysis in a `results`, or `outputs` directory.
...
own functions. It's a good idea to separate this code into two separate folders; one
